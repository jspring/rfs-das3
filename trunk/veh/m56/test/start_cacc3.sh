...
/home/das3/veh/m56/test/stop_cacc3.sh
sleep 2
echo Starting db_slv...
/home/path/db/lnx/db_slv &
sleep 1
echo Starting cacc3_create...
/home/das3/veh/m56/src/lnx/cacc3_create &
sleep 1 
...
/home/das3/veh/m56/src/lnx/wrfiles_cacc3 -m 2 -t 50 -d $tripdir -c $VEH -i 1>$tripdir/wrfiles_cacc3.log 2>$tripdir/wrfiles_cacc3.err &
sleep 2
