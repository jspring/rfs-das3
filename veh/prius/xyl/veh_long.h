...
#define bool_typ           int
#define MAX_DCC                     0.8
//#define DES_FOLLOW_DIST             10.0   //10.0     
...
#define TRANS_T			            3.0   // 4.0 is OK on 020617
...
//#define Dist_Delta			5.0  // fro freeway
#define Dist_Delta			2.5		// for short distance following
//#define Gap_rate			0.1
#define GPS_DIST_THRESH		100.0	//[m]
#define TRUCK_LEN			20.0	// [m] truck length: 20.0; tractor length: 7.9; with PMG test trciler: 21.65
#define CAR_LEN				5.5	
#define	MIN_GAP				4.0
#define E_BRK_T				3.0
#define COMB_DIST_THRESH	1.0
#define YAW_RT_THRESH		0.025  //0.01  
//#define YAW_AG_THRESH		2.0
#define T_GAP_THRESH		2.05
#define CRUISE_T            60.0    
//#define COMM_FAULT
//#ifndef TEST_TRACK
//	#define TEST_TRACK
//#endif
