...
static db_id_t db_vars_list[] = {
        ...
        {DB_USB4761_DIGIN_VAR, sizeof(usb4761_digin_typ)},
};
...
int main(int argc, char *argv[])
{
	 ...
	 */
	audi.ignition.digin = 1;	// assume on unless set off by driver
	db_clt_write(pclt, DB_AUDI_VAR, sizeof(audi_t), (void *) &audi); 
	if (verbose)
