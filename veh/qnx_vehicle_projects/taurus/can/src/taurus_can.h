...
#define MASK_b7	 0x80
#define TAURUS_IGNITION_MASK 0X01
...
/*******************************************************************************
 *      taurus_vehicle_speed
 *      Message ID      0xB4
 *      Transmitted every 40 ms
 *
 *	dbvar = DB_TAURUS_MSGB4_VAR
 *
 *	veh_spd_CAN1_kph
 *      Byte Position   6-7
 *      Bit Position    0
...
} taurus_vehicle_speed_t;

static inline void get_taurus_vehicle_speed(unsigned char *data, taurus_vehicle_speed_t *p) { 
...
/*******************************************************************************
 *      taurus_accel_cmd_status
 *      Message ID      0x343
 *      Transmitted every 40 ms
 *
 *	dbvar = DB_TAURUS_MSG343_VAR
 *
 *	message_counter
 *      Byte Position   0
 *      Bit Position    0
...
} taurus_accel_cmd_status_t;

static inline void get_taurus_accel_cmd_status(unsigned char *data, taurus_accel_cmd_status_t *p) {
...
} taurus_cruise_control_state_t;

static inline void get_taurus_cruise_control_state(unsigned char *data, taurus_cruise_control_state_t *p) {
...
/* TODO
** printmsg - prints parsed contents of TAURUS CAN message to stdout
*/
